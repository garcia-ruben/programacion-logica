        ...
        <div class="flex-shrink-0 p-3 col-2 d-none d-lg-inline vh-100 d-flex flex-column align-items-center" style="background: #07311B">
            ...
            <ul class="rounded fondo border border-secondary list-unstyled">
                <li class="mb-1">
                    ...
                    <button class="fondo text-start col-12 btn-toggle d-inline-flex align-items-center border-0 collapsed d-none d-lg-flex border-secondary border-top" id="opciones-toggle" data-bs-toggle="collapse" data-bs-target="#opciones-collapse" aria-expanded="false">
                    ...
                    <button class="fondo text-start col-12 btn-toggle d-inline-flex align-items-center border-0 collapsed border-secondary border-top d-none d-lg-flex" id="historial-toggle" data-bs-toggle="collapse" data-bs-target="#historial-collapse" aria-expanded="false">
                        <span class="material-symbols-outlined">expand_more</span>
